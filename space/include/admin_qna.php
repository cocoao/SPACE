<div class="adminTab">
  ...
  <button type="button" class="active" onclick="javascript:location.href='/space/pages/admin/admin.php?key=admin_qna'">Q&A</button>
</div>
<div class="adminPanel qnaAdmin">
      ...
      <div class="adminTable">
        <ul class="adminList">
      <?php
      include $_SERVER["DOCUMENT_ROOT"]."/space/data/ajax/qna_admin_ajax.php"
      ?>
        </ul>
        <div class="bottomBox">
