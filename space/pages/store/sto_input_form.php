    ...
    <section class="contents sto">
      <div class="center clear">
        <div class="title">
          <h2>Store Space</h2>
          <div class="linkBox">
            <hr><a href="/space/pages/store/sto.php">view all design</a>
          </div>
        </div><!-- end of common title -->
        <div class="uploadBox">
          <form action="/space/php_process/pages/sto_insert.php" method="post" name="uploadForm" class="uploadForm" enctype="multipart/form-data">
            <div class="inputUnit">
              <p class="title_input">
